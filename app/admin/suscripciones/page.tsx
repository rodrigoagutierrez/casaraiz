...
import { AddSubscriptionForm } from "@/modules/admin/components/AddSubscriptionForm";
          ...
          <tbody>
            {rows.map((s) => (
              <tr key={s.id} className="border-b border-mar-50 last:border-0">
                ...
                <td className="p-3">
                  {s.kind === "seasonal" ? (
                    <span className="rounded-full bg-otono-100 px-2 py-0.5 text-xs font-medium text-otono-700">Temporada</span>
                  ) : (
                    <span className="rounded-full bg-mar-100 px-2 py-0.5 text-xs text-mar-800">{s.origin === "manual" ? "Manual" : "Stripe"}</span>
                  )}
                </td>
                <td className="p-3">
                ...
                <td className="p-3 text-mar-950/65">{s.adminNote ?? "—"}</td>
                <td className="p-3">
